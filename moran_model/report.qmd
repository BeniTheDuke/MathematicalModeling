...
for i in range(0,101,10):
  ...
  for run in range(1000):
    count.append(moran_model.run_until_absorption())
    obs_fix = (count.count(100))/1000
  
  print(i, fix_prob, obs_fix)
...
for i in range(10,91,10):
  for r in np.arange(0.2,2.1,0.4):
    ...
    print(i, f"{r:.2f}", f"{fix_prob:.4f}", f"{obs_fix:.4f}")
